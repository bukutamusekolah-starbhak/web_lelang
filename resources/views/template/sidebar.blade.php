        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="active"><a class="nav-link" href='petugas.index'>Data Petugas</a></li>
              ...
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-th"></i> <span>Barang</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href='barang.index'>Data Barang</a></li>
                  <li><a class="nav-link" href='barang.create'>Tambah Barang</a></li>
